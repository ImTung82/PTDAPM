        ...
        <div className="flex gap-x-30">
          ...
          <div className="w-3/4">
              ...
              <div className="space-y-3">
                  ...
                  <p><b>Nộp đơn đăng kí tại: <a href="https://www.vietnamworks.com/?utm_source_navi=header&utm_medium_navi=vnwlogo" className="underline hover:text-[#C10629] transition-all duration-200 ease-out" target="_blank">https://www.vietnamworks.com/?utm_source_navi=header&utm_medium_navi=vnwlogo</a></b></p>
              </div>
          </div>
